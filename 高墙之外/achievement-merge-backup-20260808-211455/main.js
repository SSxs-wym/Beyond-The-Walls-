...
function handleSideRouteCellInput() {
  ...
  if (InputSystem.actionPressed("interact") && interaction && interaction.id === "sideRouteBed") {
...
function getActiveCellInteraction() {
  ...
  if (isSideRouteCellReturn()) {
    return GameState.sideRoute.cellSleepPhase === "idle" && isPlayerNearCellBed() ?
      { id: "sideRouteBed" } : null;
  }
