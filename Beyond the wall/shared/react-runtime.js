/*!
 * Bundled React and React DOM 19.2.8 runtime.
 * Copyright (c) Meta Platforms, Inc. and affiliates. Licensed under MIT.
 * See ../licenses/React-MIT.txt and ../THIRD_PARTY_NOTICES.md.
 */
(function () {
"use strict";
...
var e = Object.create, t = Object.defineProperty, n = Object.getOwnPropertyDescriptor, r = Object.getOwnPropertyNames, i = Object.getPrototypeOf, a = Object.prototype.hasOwnProperty, o = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), s = (e, i, o, s) => {
	...
	function Fc(e, t, n) {
		switch (t.tag) {
			...
			case 19:
				var i = (e.flags & 128) != 0;
				if (r = (n & t.childLanes) !== 0, r || (oa(e, t, n, !1), r = (n & t.childLanes) !== 0), i) {
	...
	// Offline review build: disable React DOM's optional resource preloading helpers.
	var bf = null;
	function xf(e, t, n) {
		var r = bf;
		if (r && typeof t == "string" && t) {
			...
			i = "link[rel=\"" + e + "\"][href=\"" + i + "\"]", typeof n == "string" && (i += "[crossorigin=\"" + n + "\"]"), hf.has(i) || (hf.add(i), e = {
				...
				crossOrigin: n,
				href: t
			}, r.querySelector(i) === null && (t = r.createElement("style"), Pd(t, "link", e), Ot(t), r.head.appendChild(t)));
		}
	}
	function Sf(e) {
	...
	function wf(e, t, n) {
		...
		if (r && e && t) {
			...
			mf.has(a) || (e = h({
				...
				as: t
			}, n), mf.set(a, e), r.querySelector(i) !== null || t === "style" && r.querySelector(jf(a)) || t === "script" && r.querySelector(Ff(a)) || (t = r.createElement("style"), Pd(t, "link", e), Ot(t), r.head.appendChild(t)));
		}
	}
	function Tf(e, t) {
		_f.m(e, t);
		...
		if (n && e) {
			...
			if (!mf.has(a) && (e = h({
				...
				r = n.createElement("style"), Pd(r, "link", e), Ot(r), n.head.appendChild(r);
			}
		}
	}
	function Ef(e, t, n) {
	...
	function Df(e, t) {
		...
		if (n && e) {
			...
			a || (a = n.querySelector(Ff(i)), a || (e = h({
				src: e,
				async: !0
			}, t), (t = mf.get(i)) && zf(e, t), a = n.createElement("template"), Ot(a), Pd(a, "link", e), n.head.appendChild(a)), a = {
				type: "script",
				instance: a,
				count: 1,
				state: null
	...
	function Nf(e, t, n, r) {
		e.querySelector("link[rel=\"preload\"][as=\"style\"][" + t + "]") ? r.loading = 1 : (t = e.createElement("style"), r.preload = t, t.addEventListener("load", function() {
			return r.loading |= 1;
	...
	function If(e, t, n) {
		if (t.count++, t.instance === null) switch (t.type) {
			...
			case "stylesheet":
				...
				r = Mf(n), (a = mf.get(a)) && Rf(r, a), o = (e.ownerDocument || e).createElement("style"), Ot(o);
				var s = o;
				return s._p = new Promise(function(e, t) {
					s.onload = e, s.onerror = t;
				}), Pd(o, "link", r), t.state.loading |= 4, Lf(o, n.precedence, e), t.instance = o;
			case "script": return o = Pf(n.src), (a = e.querySelector(Ff(o))) ? (t.instance = a, Ot(a), a) : (r = n, (a = mf.get(o)) && (r = h({}, n), zf(r, a)), e = e.ownerDocument || e, a = e.createElement("template"), Ot(a), Pd(a, "link", r), e.head.appendChild(a), t.instance = a);
	...
	function Gf(e, t, n, r) {
		if (n.type === "stylesheet" && (typeof r.media != "string" || !1 !== matchMedia(r.media).matches) && !(n.state.loading & 4)) {
			if (n.instance === null) {
				...
				a = t.ownerDocument || t, r = Mf(r), (i = mf.get(i)) && Rf(r, i), a = a.createElement("style"), Ot(a);
				var o = a;
	...
	n(), t.exports = h();
})), _ = /* @__PURE__ */ c(u(), 1), v = g();
function __bwmJsx(type, props, key) {
  let resolvedKey = key === undefined ? null : String(key);
  let resolvedProps;
  if (props && Object.prototype.hasOwnProperty.call(props, "key")) {
    resolvedKey = String(props.key);
    resolvedProps = {};
    for (const name in props) if (name !== "key") resolvedProps[name] = props[name];
  } else {
    resolvedProps = props || {};
  }
  const ref = resolvedProps.ref;
  return {
...
window.BeyondWallsReactRuntime = Object.freeze({
  version: "19.2.8",
  React: _,
  ReactDOM: v,
  jsxRuntime: Object.freeze({ jsx: __bwmJsx, jsxs: __bwmJsx })
});
})();
